...
*/
var File = (function () {
    File.prototype._TIMEINTERVAL = 30 * 60 * 1000;

    function File(fileDir, fileName) {
    ...
    Object.defineProperty(File.prototype, "fullPath", {
        ...
        */
        ...
        set: function (path) {
            var _ref, _ref1;
            if (os.type() === 'Windows_NT') {
              return _ref = path.split('\\'), this.fileDir = _ref[0], this.fileName = _ref[1], _ref;
            } else {
              return _ref1 = path.split('/'), this.fileDir = _ref1[0], this.fileName = _ref1[1], _ref1;
            }
        },
        enumerable: true,
        configurable: true
