  ...
  <div style="width:100%;height:100%;" ref="main" id="main">
    <el-row style="height:100%;">
      ...
      <el-col :span="16" style="padding:20px;">
        <el-form ref="form" :model="form" label-width="220px" :style="style_form" :disabled="true">
          ...
          <div style="padding: 15px 0;">
            ...
            <div style="margin-top: 10px; text-align: left;" v-if="checkedList1.length>0">
          ...
          <div style="padding: 15px 0;">
            ...
            <div style="margin-top: 10px; text-align: left;" v-if="checkedList2.length>0">
